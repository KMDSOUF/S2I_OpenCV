...
public class OpenCV {
    public static void main(String[] args) throws Exception {
        ...
        CvPoint nosePoints = new CvPoint(3);
        ...
        while (frame.isVisible() && (grabbedImage = converter.convert(grabber.grab())) != null) {
            ...
            for (int i = 0; i < total; i++) {
                ...
                //cvCircle(grabbedImage, cvPoint(x+w/3, y+h/3), w/10, CvScalar.RED, CV_FILLED,CV_AA,0);
                //cvCircle(grabbedImage, cvPoint(x+2*w/3, y+h/3), w/10, CvScalar.RED, CV_FILLED,CV_AA,0);
                
                cvCircle(grabbedImage, cvPoint(x+w/2, y+2*h/3), w/10, CvScalar.BLUE, CV_FILLED,CV_AA,0);
               
                R.mouseMove(((frame.getWidth()-x)) *5, (y) *5);
                if (h>200)
